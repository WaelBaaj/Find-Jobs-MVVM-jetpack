...
import com.wa82bj.findgitjobs.BuildConfig
import com.wa82bj.findgitjobs.data.api.FindGithubJobsApi
import com.wa82bj.findgitjobs.data.api.NetworkInfo
...
class NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideGitHubJobsApiService(retrofit: Retrofit): FindGithubJobsApi = retrofit.create(FindGithubJobsApi::class.java)
